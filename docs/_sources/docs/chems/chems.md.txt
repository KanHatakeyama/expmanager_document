...
- Molecular structures can be recorded as SMILES strings
- SMILES can be generated by molecule editors, such as ChemDraw
![](figs/smiles.png)
- [JSME](https://jsme-editor.github.io/dist/JSME_test.html) is also known as a free molecule editor
## APPENDIX B: Polymer structures
- Polymer structures can be recorded as custom MOL formats
- For details, visit [here](https://github.com/KanHatakeyama/PolyMolParser)